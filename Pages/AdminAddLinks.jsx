...
import { createBlogList } from '../src/services/admin-auth.service'
                ...
                <div className="AdContent">
                    ...
                    <div className="adRightContent">
                        <div className="pathSec">
                            ...
                            <div className="path">
                                Admin	&gt; Blogs	&gt; <span> Add Blogs</span>
                            </div>
                        </div>
                        {/* add tag form */}
                            ...
                            <div className="row">
                                <div className="col-lg-8">
                                    ...
                                    <div className="form">
                                        {title}
                                        <div className="inBox">
                                            <div className="inTitle">Title<span className='req'>*</span> </div>
                                            <input type="text" name="" value={title} onChange={(e) => {
                                                SetTitle(e.target.value)
                                            }} className='inText' placeholder='Enter title' id="" />
                                        </div>
                                        <div className="inBox">
                                            <div className="inTitle">Content <span className='req'>*</span> </div>
                                            <input type="text" name="" value={content} onChange={(e) => {
                                                SetContent(e.target.value)
                                            }} className='inText' placeholder='Enter content' id="" />
                                        </div>
                                        {/* <div className="inBox">
...
reader.readAsDataURL(e.target.files[0]);
                                        ...
                                        <div className="formBtns">
                                            <button className="add" onClick={() => { addBlogs() }} >
                                                Add Blogs
                                            </button>
                                            <Link to={'/admin-links'}>
