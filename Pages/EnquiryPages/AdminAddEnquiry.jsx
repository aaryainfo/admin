...
import { createEnquiryList } from "../../src/services/enquiry.service";

function AdminAddEnquiry() {
  ...
  async function addEnquiry() {
    try {
      ...
      console.log(payload);
      const enquiryList = await createEnquiryList(payload);
        ...
        <div className="AdContent">
          ...
          <div className="adRightContent">
            <div className="pathSec">
              <div className="title">Add Enquiry</div>
              <div className="path">
                Admin &gt; Enquiry &gt; <span> Add Enquiry</span>
              </div>
            </div>
            {/* add tag form */}
            <div className="formDiv">
              <div className="row">
                <div className="col-lg-8">
                  <div className="formTitle">Add Enquiry</div>
                  <div className="form">
                    <div className="inBox">
