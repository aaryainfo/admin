...
function AdminUpdateEnquiry() {
  ...
  async function getEnquiryId() {
    try {
      const payload = { id: id };
      const getEnquiry = await getEnquiryWithId(payload);
      const data = getEnquiry.data; // await res.json()
  ...
  async function updateEnquiry() {
    try {
      ...
      console.log(payload);
      const enquiryList = await updateEnquiryList(payload);
      const data = enquiryList.data;
        ...
        <div className="AdContent">
          ...
          <div className="adRightContent">
            <div className="pathSec">
              <div className="title">Update Enquiry</div>
              <div className="path">
                Admin &gt; Enquiry &gt; <span> Update Enquiry</span>
              </div>
            </div>
            {/* add tag form */}
            ...
            <div className="formDiv">
              <div className="row">
                <div className="col-lg-8">
                  <div className="formTitle">Update Enquiry</div>
                  <div className="form">
                    <div className="inBox">
...
export default AdminUpdateEnquiry;
