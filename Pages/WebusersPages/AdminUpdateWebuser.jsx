...
function AdminUpdateWebuser() {
  ...
  async function getWebuserId() {
    try {
      const payload = { id: id };
      const getWebuser = await getWebuserWithId(payload);
      const data = getWebuser.data; // await res.json()
  ...
  async function updateWebuser() {
    try {
      ...
      console.log(payload);
      const webuserList = await updateWebuserList(payload);
...
export default AdminUpdateWebuser;
