...
import { createWebuserList } from "../../src/services/webuser.service";

function AdminAddWebuser() {
  ...
  async function addWebuser() {
    try {
      ...
      console.log(payload);
      const webuserList = await createWebuserList(payload);
      const data = webuserList.data;

      if (data) {
        toast.success("Product Added Successfully");
        navigate("/admin-webusers");
      } else {
        ...
        <div className="AdContent">
          ...
          <div className="adRightContent">
            <div className="pathSec">
              ...
              <div className="path">
                Admin &gt; Customers &gt; <span> Add Customer</span>
              </div>
            </div>
            {/* add tag form */}
            <div className="formDiv">
              <div className="row">
                <div className="col-lg-8">
                  <div className="formTitle">Add Customer</div>
                  <div className="form">
                    <div className="inBox">
...
export default AdminAddWebuser;
