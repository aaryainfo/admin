...
function AdminUpdateProperty() {
  ...
  async function getPropertyId() {
    try {
      const payload = { id: id };
      const getProperty = await getPropertyWithId(payload);
      const data = getProperty.data; // await res.json()
      ...
      setTagIsHot(data.isHot);
      setTagIsActive(data.isActive);
      // const updatedImage =
      ...
      // setImages(data.images || [updatedImage]);
    } catch (error) {
      console.log(error);
    }
  }
  ...
  async function updateProperty() {
    try {
      ...
      console.log(payload);
      const propertyList = await updatePropertyList(payload);
      const data = propertyList.data;
        ...
        <div className="AdContent">
          ...
          <div className="adRightContent">
            <div className="pathSec">
              <div className="title">Update Property</div>
              <div className="path">
                Admin &gt; Properties &gt; <span> Update Property</span>
              </div>
            </div>
            {/* add tag form */}
            ...
            {/* <div className="formDiv">
              <div className="row">
                <div className="col-lg-8">
                  <div className="formTitle">Update Blog</div>
